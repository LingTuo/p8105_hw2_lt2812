...
As for the final dataset, there are `r nrow(pols_snp_unemploy)` rows and `r ncol(pols_snp_unemploy)` columns. It combines above three datasets including variables of date(year, month, day), president, percentage of unemployment, etc. The range of years is [`r range(pull(pols_snp_unemploy, year))`].
